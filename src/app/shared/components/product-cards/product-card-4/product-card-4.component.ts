...
@Component({
  selector: 'app-product-card-4',
  templateUrl: './product-card-4.component.html',
  styleUrl: './product-card-4.component.scss',
  imports: [
    ProductPricePipe,
...
export class ProductCard4Component implements OnInit, OnDestroy {
  // Decorator
